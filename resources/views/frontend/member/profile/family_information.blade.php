...
<div class="card">
        ...
        <form action="{{ route('families.update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <input type="text" name="father_phone" value="{{ $member->families->father_phone ?? "" }}" placeholder="{{ translate('Father Phone Number') }}" class="form-control" required>
                    @error('father_phone')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <input type="text" name="mother_phone" value="{{ $member->families->mother_phone ?? "" }}" placeholder="{{ translate('Mother Phone Number') }}" class="form-control" required>
                    @error('mother_phone')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <input type="text" name="guardian_name" value="{{ $member->families->guardian_name ?? "" }}" placeholder="{{ translate('Guardian Name') }}" class="form-control" required>
                    @error('guardian_name')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-md-6 mt-2">
                    ...
                    <input type="text" name="guardian_phone" value="{{ $member->families->guardian_phone ?? "" }}" placeholder="{{ translate('Guardian Phone Number') }}" class="form-control" required>
    ...
    @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="sibiling_phone[]" value="{{ isset($sibiling_phone[$index]) ? $sibiling_phone[$index] : '' }}" class="form-control" placeholder="{{translate('Sibling Phone Number')}}" required>
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="grand_father" value="{{ $member->families->grand_father ?? "" }}" class="form-control" placeholder="{{translate('Grand Father Name (Maternal)')}}" required>
                    @error('grand_father')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="col-md-6">
                    ...
                    <input type="text" name="grand_mother" value="{{ $member->families->grand_mother ?? "" }}" class="form-control" placeholder="{{translate('Grand Mother Name (Maternal)')}}" required>
                    @error('grand_mother')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
