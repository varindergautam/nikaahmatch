				...
				<div class="card">
					<div class="card-body">
						...
						<form class="form-default" id="reg-form" role="form" action="{{ route('register') }}" method="POST">
							...
							<div class="row">
						        <div class="col-lg-6">
						            <div class="form-group mb-3">
										...
										<input type="text" class="form-control @error('first_name') is-invalid @enderror"  name="first_name" id="first_name" placeholder="{{translate('First Name')}}"  value="{{ old('first_name') }}" onchange="validation();" required>
										@error('first_name')
											<span class="invalid-feedback" role="alert">{{ $message }}</span>
										@enderror
						            </div>
						        ...
						        <div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="text" class="form-control @error('middle_name') is-invalid @enderror" name="middle_name" id="middle_name" placeholder="{{ translate('Middle Name') }}"  value="{{ old('middle_name') }}" >
										@error('middle_name')
										<span class="invalid-feedback" role="alert">{{ $message }}</span>
										@enderror
									</div>
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name" placeholder="{{ translate('Last Name') }}"  value="{{ old('last_name') }}" >
										@error('last_name')
										<span class="invalid-feedback" role="alert">{{ $message }}</span>
										@enderror
									</div>
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="text" class="form-control @error('phone') is-invalid @enderror" onchange="validation();" name="phone" value="{{ old('phone') }}" id="phone" placeholder="{{ translate('Mobile Number') }}"  >
										@error('phone')
										<span class="invalid-feedback" role="alert">{{ $message }}</span>
										@enderror
									</div>
							...
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group mb-3">
										...
										<input type="text" onchange="validation();" class="form-control aiz-date-range @error('date_of_birth') is-invalid @enderror" name="date_of_birth" id="date_of_birth" placeholder="{{ translate('Date Of Birth') }}" data-single="true" data-show-dropdown="true" data-max-date="{{ get_max_date() }}" autocomplete="off" value="{{ old('date_of_birth') }}" required>
										@error('date_of_birth')
										<span class="invalid-feedback" role="alert">{{ $message }}</span>
										@enderror
									</div>
							...
							<div class="row">
								<div class="col-lg-12">
								  <div class="form-group mb-3">
										...
										<input type="email" onchange="validation();" class="form-control @error('email') is-invalid @enderror" name="email" id="signinSrEmail" value="{{ old('email') }}" placeholder="{{ translate('Email Address') }}" >
								        @error('email')
								            <span class="invalid-feedback" role="alert">{{ $message }}</span>
								        @enderror
								  </div>
								...
								<div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" name="password" onchange="validation();" id="password" value="{{ old('password') }}" placeholder="********" aria-label="********" required>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="password" class="form-control" value="{{ old('first_name') }}"  id="password_confirmation" onchange="validation();" name="password_confirmation" placeholder="********" required>
							...
							<div class="mb-5">
                                    <button type="submit" class="btn btn-block btn-primary" id="submitBtn">{{ translate('Create Account') }}</button>
                                    <button type="button" class="btn btn-block btn-primary" id="disable" disable>{{ translate('Fill Required Details') }}</button>
...
function validation() {
    ...
    if (inputValue === '' || phone === '' || date_of_birth === '' || email === '' || password === '' || password_confirmation === '') {
